...
R8_STATISTICS_SCHEMA = "diablogym-r8-paired-statistics/1"
R8_METHOD_REVISION = "paired-t-sign-death-mcnemar-exact/1"
...
def analyze_paired_archives(
    ...
    *,
    ...
    if discordant_pairs:
        candidate_only_theta_upper = _clopper_pearson_upper(
            candidate_only_deaths, discordant_pairs, component_alpha
        )
        death_difference_upper = (
            (2.0 * candidate_only_theta_upper - 1.0)
            * discordant_pairs / n_pairs
        )
    else:
        candidate_only_theta_upper = 0.0
        death_difference_upper = 0.0
    ...
    death_report = {
        ...
        "candidate_only_conditional_theta_upper_bound":
            candidate_only_theta_upper,
    ...
    result = {
        "schema_version": R8_STATISTICS_SCHEMA,
        "method_revision": R8_METHOD_REVISION,
        "phase": phase,
        "n_pairs": n_pairs,
