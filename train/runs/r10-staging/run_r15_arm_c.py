...
def main():
    log({"event": "arm_g_launch", "arm": ARM, "total_steps": TOTAL_STEPS,
         "step_law": "T=round2048(266240/(1-0.186)),G0-9 定标",
         "lever": "readiness-v2 + 战备条件托管(修正案二:未达标下楼分文不入)+ 托管 0.5×d^1.6 + a11 杠杆 2.0"})
    ...
    probes = (
        ("deploy3-new-a", new_worker, "2114000-2114127"),
        ("deploy3-new-b", new_worker, "2115000-2115127"),
        ("deploy3-base-a", RUNS / "r14-arm-b-wage" / "model_candidate.zip",
         "2114000-2114127"),
        ("deploy3-base-b", RUNS / "r14-arm-b-wage" / "model_candidate.zip",
         "2115000-2115127"),
    )
    ...
    log({"event": "arm_g_stage_complete", "next": "四门配对对判 + 部署对照 + 呈主席终裁"})
