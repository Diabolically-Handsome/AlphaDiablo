...
class PlanAExpansionTests(_PatchMixin, unittest.TestCase):
    ...
    def test_factor_constant_and_seed_extension_rule(self):
        ...
        self.assertEqual(bc_worker.DEMO_SEEDS_V2[-1], 2_143_383)
    ...
    def test_active_pool_marker_identity_cannot_alias_burned_predecessors(self):
        ...
        self.assertEqual(
            active_v1[1],
            "752f515050bd3e2f35cd123a403f3da42"
            "b4c746e553e9cd1568774d6cbb0e2b9")
        self.assertEqual(
            active_v2[1],
            "867d03768ed884fd9cb0fa6c1b566cbde"
            "cc1cef41af9810f092f5cbdbf620915")
